...
impl Router {
    ...
    fn nudge_orthogonal_routes(&mut self) {
        ...
        let nudge_touching_colinear = self.routing_option(RoutingOption::NudgeOrthogonalTouchingColinearSegments);
        channel_router.nudge_routes_with_obstacles_and_options(&mut routes, &obstacles, nudge_shape_connected, nudge_touching_colinear);
